...
class BlogRepository extends BaseRepository implements BlogContract
{
    ...
    public function updateBlog(array $params)
    {
        ...
        // dd($blog->blog_category_id, $collection['blog_category_id'], $collection['blog_category_id'][0]);

        // if( !empty($collection['blog_category_id']) && ($collection['blog_category_id'][0] != null)) {
 ...
 /**
    ...
    public function latestBlogs(){
        $blogs = Blog::where('image','!=','')->orderby('id','desc')->paginate(8);
        //dd($blogs);
        return $blogs;
    ...
    public function getRelatedBlogs($categoryId,$id){
        $blogs = Blog::with('category')->where('blog_category_id',$categoryId)->where('id','!=',$id)->orderby('id','desc')->get();
