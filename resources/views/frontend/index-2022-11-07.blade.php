...
@section('title')
@php
 $meta_title=DB::table('seo_management')->where('page', '=', 'homepage')->get();
                ...
                <figure>
                    @if($blog->image!='')
                        <!-- <a data-fancybox href="#myVideo">
                            <img src="{{ asset('Extra/1650609444.play-img.png') }}">
                        </a> -->
...
@push('scripts')
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDbT-LjisuP4CnRb3BKWdeJzB4tNYKWPXM&libraries=places"></script>
