    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <form action="{{ route('admin.directory.index') }}">
                        ...
                        <tbody>
                            @foreach($directory as $key => $blog)
                                <tr>
                                    ...
                                    <td>
                                        {{-- {{ $blog->category_id }} --}}
                                        {{ directoryCategoryStr($blog->category_id) }}
                                    </td>
                                    <td>{{$blog->address}}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.directory.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).on("click", ".sa-remove", function() {
            ...
            function(isConfirm){
                if (isConfirm) {
                    window.location.href = "directory/"+id+"/delete";
                } else {
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.directory.updateStatus')}}",
