    ...
    <div class="app-title">
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
                {{-- <a href="{{ route('admin.event.mail') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Send Mail</a> --}}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                <div class="col">
                    <ul>
                        <li class="active">Total Event Organiser who have registered <span class="count">({{$event->total()}})</span></a></li>
                        {{-- @php
                ...
                <div class="col-auto">
                    <form action="{{ route('admin.event-organiser.index') }}">
                            ...
                            @foreach($event as $key => $item)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.event-organiser.mail', $item['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-envelope"></i></a>
                                        <a href="{{ route('admin.event-organiser.view', $item['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                                </tr>
                            @endforeach
