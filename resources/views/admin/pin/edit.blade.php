                ...
                <form action="{{ route('admin.pin.update') }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" type="text"
                                ...
                                {{ old('description', $targetpin->description) }}</textarea>
                            <input type="hidden" name="id" value="{{ $targetpin->id }}">
                            @error('description')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                            ...
                            <input class="form-control @error('meta_title') is-invalid @enderror" type="text" name="meta_title"
                                id="meta_title" value="{{ old('meta_title',$targetpin->meta_title) }}" />
                            @error('meta_title')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" type="text"
                                name="meta_description" id="summernote-meta_description">{{ old('meta_description',$targetpin->meta_description) }}</textarea>
