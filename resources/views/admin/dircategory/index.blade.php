    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-9 text-right">
                ...
                <form action="{{ route('admin.dircategory.image.upload') }}" enctype="multipart/form-data" id="bulk_image_form" method="POST">@csrf
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="btn-group">
                                    ...
                                    <a href="{{ route('admin.dircategory.index') }}" class="btn btn-danger btn-sm">Remove filter</a>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <tbody>
                                @foreach ($categories as $key => $category)
                                    <tr>
                                        ...
                                        <td><img src="{{URL::to('/').'/categories/'}}{{$category->parent_category_image}}" height="100px"></td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Second group">
                                                <a href="{{ route('admin.dircategory.edit', $category['id']) }}"
                                                    class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                                <a href="{{ route('admin.dircategory.details', $category['id']) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.dircategory.data.csv.store') }}"
