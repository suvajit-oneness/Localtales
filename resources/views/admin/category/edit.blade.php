    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.category.update') }}" method="POST" role="form" enctype="multipart/form-data">@csrf
                    <div class="tile-body">
                                ...
                                @foreach($faq as $key => $blog)
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            ...
                                            <a href="{{ route('admin.categoryfaq.delete', $blog['id']) }}"  class="btn btn-sm btn-primary edit-btn"><i class="fa fa-trash"></i></a>
