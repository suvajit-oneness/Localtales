            ...
            <div class="tile">
                ...
                <form action="{{ route('business.event.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <div class="select-floating-admin">
                                <label class="control-label" for="category_id">Category ({!! eventCategory($targetEvent->category_id) !!})<span class="m-l-5 text-danger"> *</span></label>
                        ...
                        {{-- <div class="form-group">
                            <label class="control-label" for="business_id">Directory ({!! eventBusiness($targetEvent->directory_id) !!})<span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" name="short_description" id="">{{ old('short_description',$targetEvent->short_description) }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="host" onClick="hostCheck();" id="yesCheck" value="Local tales"

                                        {{ $targetEvent->host == "Local tales" ? 'checked' : '' }}
                        ...
                        <div id="ifYes">
                            @if($targetEvent->host != 'Local tales')
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            *</span></label>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onClick="eventtypeCheck();" id="online" name="type" value="online" {{ $targetEvent->type == "online" ? 'checked' : '' }}>
                                ...
                                <div class="col-8">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onClick="eventtypeCheck();" id="person" name="type" value="in person" {{ $targetEvent->type != "online" ? 'checked' : '' }}>
                        ...
                        <div id="typePerson">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="state">
                                    ...
                                    @foreach ($state as $index => $item)
                                        <option
                                            value="{{ $item->short_code }}" {{($targetEvent->state == $item->short_code) ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="name">PostCode @if($targetEvent->pin)({{$targetEvent->pin}})@endif<span class="m-l-5 text-muted"> (optional)</span></label>
                            ...
                            <div class="form-group">
                                <label class="mb-1">Suburb @if($targetEvent->suburb)({{$targetEvent->suburb}})@endif<span class="m-l-5 text-muted"> (optional)</span></label>
                        ...
                        <div id="typeOnline">
                            <div class="form-group">
                                <label class="control-label" for="link"> Link <span class="m-l-5 text-muted">(optional)</span></label>
                                <input class="form-control @error('link') is-invalid @enderror" type="text"
                                    name="link" id="link" value="{{ old('link',$targetEvent->link) }}" placeholder="eg: https://zoom.us/j/5551112222" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onClick="CostCheck();" id="free" name="is_paid" value="0" {{ $targetEvent->is_paid == 0 ? 'checked' : '' }}>
                                ...
                                <div class="col-8">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onClick="CostCheck();" id="premium" name="is_paid" value="1" {{ $targetEvent->is_paid == 1 ? 'checked' : '' }}>
                        ...
                        <div id="Eventcost">
                            <div class="form-group">
                                ...
                                name="price" id="event_cost" value="{{ old('price',$targetEvent->price) }}"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-check">
                                        ...
                                        id="recurring" name="is_recurring" value="1" {{ $targetEvent->is_recurring == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-8">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onClick="recurringCheck();"
                                        id="norecurr" name="is_recurring" value="0" {{ $targetEvent->is_recurring == 0 ? 'checked' : '' }}>
                            ...
                            <div id="yes">
                                <div class="form-group">
                                    <select name="recurring" id="skim"
                                        ...
                                        <option value="">Select an option</option>
                                        <option value="daily" {{ 'daily' == $targetEvent->recurring ? 'selected' : '' }}>Daily</option>
                                        <option value="weekly" {{ 'weekly' == $targetEvent->recurring  ? 'selected' : '' }}>Weekly</option>
                                        <option value="monthly" {{ 'monthly' ==$targetEvent->recurring  ? 'selected' : '' }}>Monthly</option>
                                        <option value="yearly" {{ 'yearly' == $targetEvent->recurring  ? 'selected' : '' }}>Yearly</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control @error('website') is-invalid @enderror" type="text" name="website" id="website" value="{{ old('website',$targetEvent->website) }}" placeholder="eg: https://www.google.com/"/>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    @if ($targetEvent->image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{URL::to('/').'/uploads/events/'}}{{$targetEvent->image }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">
                                    @if ($targetEvent->image1 != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{URL::to('/').'/uploads/events/'}}{{$targetEvent->image1 }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">
                                    @if ($targetEvent->image2 != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{URL::to('/').'/uploads/events/'}}{{$targetEvent->image2 }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">
                                    @if ($targetEvent->image3 != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{URL::to('/').'/uploads/events/'}}{{$targetEvent->image3 }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="form-group">
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('business.event.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
                </form>
            </div>
        </div>
