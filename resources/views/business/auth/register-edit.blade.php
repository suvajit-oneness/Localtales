                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('business.form.update',$directory->slug) }}" method="POST"   enctype="multipart/form-data">
                                ...
                                <div class="div1" id="st1">
                                    ...
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('email') is-invalid @enderror" type="text" onblur="ValidationOfBusinessEmail(this.value)" name="email" id="email" value="{{$directory->email}}" >
                                        <label class="did-floating-label">Business Email</label>
                                        <p class="small text-danger" id="businessEmailErr"></p>
                                    </div>
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('mobile') is-invalid @enderror" type="text" name="mobile" id="mobile" onblur="validatePhone(this.value)" value="{{$directory->mobile}}" >
                                        <label class="did-floating-label">Business Phone</label>
                                        <p class="small text-danger" id="businessPhoneErr"></p>
                                    </div>
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('address') is-invalid @enderror" type="text" name="address" id="address" onblur="validateAddress(this.value)" value="{{$directory->address}}" >
                                        <label class="did-floating-label">Business Address</label>
                                        <p class="small text-danger" id="businessAddressErr"></p>
                                    </div>
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('website') is-invalid @enderror" type="text" name="website" id="website" onblur="validateWebsite(this.value)" value="{{$directory->website}}" >
                                ...
                                <div class="div1" id="st2">
                                    ...
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('primary_name') is-invalid @enderror" type="text" name="primary_name" id="primary_name" onblur="validateName(this.value)" value="{{$directory->primary_name}}" >
                                        <label class="did-floating-label">Name</label>
                                        <p class="small text-danger" id="NameErr"></p>
                                    </div>
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('primary_email') is-invalid @enderror" type="email" name="primary_email" id="primary_email" onblur="ValidationOfEmail(this.value)" value="{{$directory->primary_email}}" >
                                        <label class="did-floating-label">Email Address</label>
                                        <p class="small text-danger" id="EmailErr"></p>
                                    </div>
                                    <div class="did-floating-label-content">
                                    <input class="did-floating-input @error('primary_phone') is-invalid @enderror" type="text" name="primary_phone" id="primary_phone" onblur="validatePersonPhone(this.value)" value="{{$directory->primary_phone}}" >
