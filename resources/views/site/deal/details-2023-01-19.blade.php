			...
			<div class="col-md-12 details_left">
				...
				*/ ?>
				<ul class="nav nav-tabs details_tabs" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#reviews" role="tab"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tag"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg> <span>Reviews</span></a>
						...
						<div class="swiper mySwiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<img src="{{ URL::to('/') . '/uploads/deals/' }}{{ $deal->image1 }}"
										width="200px">
								</div>
								<div class="swiper-slide">
									@if ($deal->image2)
										<img src="{{ URL::to('/') . '/uploads/deals/' }}{{ $deal->image2 }}"
											width="200px">
									@endif
								</div>
								<div class="swiper-slide">
									@if ($deal->image3)
										<img src="{{ URL::to('/') . '/uploads/deals/' }}{{ $deal->image3 }}"
											width="200px">
									@endif
								</div>
							</div>
