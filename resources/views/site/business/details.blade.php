...
{{-- @section('title')
@php
 $meta_title=DB::table('seo_management')->where('page', '=', 'directory_detail')->get();
$title=$meta_title[0]->title;
$name = str_replace("BUSINESS_NAME_HERE", $business->name, $title);
...
$meta_title = str_replace("BUSINESS_CATEGORY_HERE", $displayCategoryName, $name);
