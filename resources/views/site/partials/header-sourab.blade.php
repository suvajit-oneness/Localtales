<a type="button" class="btn help_btn" data-toggle="modal" data-target="#help_modal"><small class="d-block">Was this article</small><b>Helpful ?</b></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    {{-- <a type="button" class="btn btn-login d-flex align-items-center justify-content-center" href="{!! URL::to('site-edit-profile') !!}" style="height: 35px;">
    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
    ...
    @endif
    <a type="button" class="btn btn-login btn_buseness" href="{{ route('business.signup')}}"><img src="{{ asset('front/img/briefcase.svg')}}" width="18px" height="18px" alt=""> Business Signup</a>
    </div>
</div>
</nav>
</header>
