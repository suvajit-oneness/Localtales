                        ...
                        <div class="swiper-wrapper">
                            @if ($event->image1)
                                <div class="swiper-slide">
                                    <img src="{{ URL::to('/') . '/uploads/events/' }}{{ $event->image1 }}" width="200px">
                                </div>
                            @endif
                            @if ($event->image2)
                                <div class="swiper-slide">
                                    <img src="{{ URL::to('/') . '/uploads/events/' }}{{ $event->image2 }}" width="200px">
                                </div>
                            @endif
                            @if ($event->image3)
                                <div class="swiper-slide">
                                    <img src="{{ URL::to('/') . '/uploads/events/' }}{{ $event->image3 }}" width="200px">
                                </div>
                            @endif
                        </div>
                            ...
                            <ul class="deals-contant">
                                ...
                                <div class="row Bestdeals">
                                    @foreach ($eventBusiness as $key => $business)
                                        <div class="col-6 col-md-6 col-lg-6 mb-3 mb-lg-4">
