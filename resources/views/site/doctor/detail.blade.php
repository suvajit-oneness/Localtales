@extends('site.app')
@section('title'){{ $doctorList->title }}@endsection
@section('description')
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-md-6">
                    <div class="job__details pt-0">
                        <h1 class="">{{  $doctorList->title }}</h1>
                        <div class="job-details-heading">
                            <div class="job-details-heading-left mb-2">
                                <h4 class="company-name">{{$doctorList->type}}</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-auto">
                                <ul class="articlecat">
                                    <li>
                                        ...
                                        {{$doctorList->postcode ? $doctorList->postcode : ''}}{{$doctorList->suburb ? ', '.$doctorList->suburb : ''}}{{$doctorList->state ? ', '.$doctorList->state : ''}}
                                    </li>
                                    <li>
                                        ...
                                        {{ $doctorList->created_at->format('d M Y') }}
                                    </li>
                                    <li>
           ...
           <div class="row">
                ...
                <div class="col-md-12">
                    <div class="job-details job_right_sidebar border-0 pl-0">
                        <h3 class="job-detail-heading"></h3>

                        <ul class="job__types">
                           
                            @if($doctorList->contact != '')
                                
                            <h4>Contact information</h4> <br>
                            <p>{{$doctorList->contact}}</p>
                            <p>Email : {{$doctorList->email}}</p>
                            <p><a href="{{$doctorList->website}}" target="_blank" class="mb-0">Visit website</a></p>
                            @endif
                        </ul>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="full-job-desc">
                        ...
                        <p>{!! $doctorList->description ? $doctorList->description : 'NA' !!}</p>
                    </div>
                </div>
            </div>
        </div>
