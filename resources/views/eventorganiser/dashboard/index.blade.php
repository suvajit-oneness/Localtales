...
@section('content')
 @php
$events = App\Models\Event::where('created_by',Auth::guard('eventorganiser')->user()->id)->where('status',1)->get();
@endphp
<style type="text/css">
    .row-md-body.no-nav {
    margin-top: 70px;
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-6 col-lg-3">
            <div class="widget-small primary coloured-icon">
                ...
                <div class="info">
                    <a href="{{ route('eventorganiser.profile') }}"><h4>Edit Profile</h4></a>
                </div>
            </div>
        </div>
         <div class="col-md-6 col-lg-3">
            <div class="widget-small primary coloured-icon">
                ...
                <div class="info">
                    <a href="{{route('eventorganiser.change.password')}}"><h4>Change Password</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="widget-small primary coloured-icon">
                <i class="icon fa fa-briefcase fa-3x"></i>
                <div class="info">
                    <a href="{{ route('eventorganiser.event.index') }}"><h4><p><b>{{count($events)}} </b></p>Event</h4></a>
                </div>
            </div>
        </div>
        {{--<div class="col-md-6 col-lg-3">
