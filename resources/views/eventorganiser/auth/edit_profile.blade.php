        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
                <span class="top-form-btn">
                    <a class="btn btn-secondary" href="{{ route('eventorganiser.dashboard') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Back</a>
                </span>
                <h3 class="tile-title">Edit Profile</h3>
                <hr>
                <form action="{{ route('event-organiser-dashboard.profile.update') }}" method="POST" role="form"
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Email<span class="m-l-5 text-danger">
                                    *</span></h6>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address"
                                value="{{ Auth::guard('eventorganiser')->user()->address }}" />
                            @error('address')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="state">
                                ...
                                @foreach ($state as $index => $item)
                                    <option
                                        value="{{ $item->short_code }}" {{ $item->short_code == Auth::guard('eventorganiser')->user()->state ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Postcode @if(Auth::guard('eventorganiser')->user()->postcode)({{ Auth::guard('eventorganiser')->user()->postcode }})@endif</h6>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="mb-1">
                                <h6 class="mb-0 text-sm text-dark">Suburb @if(Auth::guard('eventorganiser')->user()->suburb)({{ Auth::guard('eventorganiser')->user()->suburb }})@endif</h6>
                            </label>
