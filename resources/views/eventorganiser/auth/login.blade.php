            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <div class="form_holder">
                        <h3>Login Now</h3>
                        <form action="{{ route('eventorganiser.login.post') }}" method="POST" role="form">
                        ...
                        <div class="row mb-4 px-3"> <small class="font-weight-bold text-muted">Don't have an account? <a class="text-orange " href="{{ route('event.registration') }}">Register</a></small> </div>
                      </form>
