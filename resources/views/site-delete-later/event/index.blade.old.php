                        ...
                        <div class="col-6 col-md-4 col-lg-4 jQueryEqualHeight">
                            <div class="card directoryCard directory_block border-0 v3card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a href="{!! URL::to('event/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $event->title))) !!}"><h4 class="place_title bebasnew">{{$event->title}}</h4></a>
                                    ...
                                    <div class="directory_block">
                                        <div>
                                            @php
                                                $only_numbers = (int)filter_var($event->contact_phone	, FILTER_SANITIZE_NUMBER_INT);
                                                if(strlen((string)$only_numbers) == 9) {
                                                    ...
                                                    $mobile_number = $event->contact_phone	;
                                                }
                                            @endphp
										...
										<div class="d-flex location_details mb-2 mb-md-0 ml-0 ml-md-2 mt-1 mt-md-0">
											@php
												...
												if (($event->contact_email == "NA" || $event->contact_email == "")) {
													echo '';
												} else {
													echo '
													<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-envalope"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
													<a href="'.$event->contact_email.'" target="_blank" class="history_details">'.$event->contact_email.'</a>';
												}
											@endphp
										</div>
                                        ...
                                        @php
                                            if (!empty($event->category_id)) {
                                                ...
                                                foreach($catArr as $catKey => $catVal) {
                                                    $catDetails = \App\Models\DirectoryCategory::select('id', 'parent_category','parent_category_slug')->where('id', $catVal)->first();

                                                    if ($catDetails) {
                                                        $displayCategoryName .= '<a class="mb-2" href="'.route("category", $catDetails->parent_category_slug).'">'.$catDetails->parent_category.'</a>, ';
                                                    }
                                                }
                                    ...
                                    <div class="v3readmore">
                                        ...
                                        <a href="{!! URL::to('event/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $event->title))) !!}" class="location_btn"><i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="list_content_wrap">
                                <div class="location_meta">
                                        ...
                                        <div class="d-flex location_details">
											...
											<div class="d-flex location_details mb-2 mb-md-0 ml-0 ml-md-2 mt-1 mt-md-0">
                                                @php
                                                    ...
                                                    if (($event->website == "NA" || $event->website == "")) {
                                                        echo '';
                                                    } else {
                                                        echo '
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                                                        <a href="'.$event->website.'" target="_blank" class="history_details">'.$event->website.'</a>';
                                                    }
                                                @endphp
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex location_details">
                                        ...
                                        <p class="location mb-0">{{$event->address}}</p>
										<p class="mb-0">{{$event->start_date}} - {{$event->end_date}}</p>
                                    </div>           
                                    <div class="categoryB-list">
                                         ...
                                         @php
                                            if (!empty($event->category_id)) {
                                                ...
                                                $displayCategoryName = '';
                                                foreach($catArr as $catKey => $catVal) {
                                                    $catDetails = \App\Models\DirectoryCategory::select('id', 'title','parent_category','parent_category_slug')->where('id', $catVal)->first();
                                    ...
                                    <div class="v3readmore">
                                        <a href="{!! URL::to('event/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $event->title))) !!}"><span>View Details</span> <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                      </li>
    ...
    <script>
        ...
        foreach($directories as $business) {
           // $img = "https://maps.googleapis.com/maps/api/streetview?size=640x640&location=".$business->latitude.",".$business->longitude."&fov=120&heading=0&key=AIzaSyDegpPMIh4JJgSPtZwE6cfTjXSQiSYOdc4";
            ...
            $page_link = URL::to('event/'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "-", $business->title)));

           // $data = array($business->name,floatval($business->latitude),floatval($business->longitude),$business->address,$img,$page_link);
           $data = array($business->title,floatval($business->latitude),floatval($business->longitude),$business->address,$page_link);
