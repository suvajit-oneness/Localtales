    ...
    <section class="form_b_sec">
        <div class="container">
            ...
            <div class="row justify-content-center py-4 py-lg-5">
                <div class="col-lg-8">
                    <form action="{{ route('advocate.registration.store') }}" method="POST"
                        ...
                        <div class="div1" id="">
                            ...
                            <div class="did-floating-label-content">
                                ...
                                @error('email')
                                    <p class="small text-danger">{{ $message }}</p>
                                @enderror
                                <label class="did-floating-label"> Email<span class="m-l-5 text-danger">
                                    *</span></label>
                            </div>
                            <div class="did-floating-label-content">
                                        ...
                                        <div
                                            ...
                                            <div class="select-floating-admin">
                                                ...
                                                @error('postcode')
                                                    <p class="small text-danger">{{ $message }}</p>
                                                @enderror
                                                <label class="did-floating-label"> Postcode<span class="m-l-5 text-danger">
                                                    (optional)</span></label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="did-floating-label-content">
                                ...
                                @error('suburb')
                                    <p class="small text-danger">{{ $message }}</p>
                                @enderror
                                <label class="did-floating-label"> Suburb<span class="m-l-5 text-danger">
                                    (optional)</span></label>
                            </div>
                            <div class="did-floating-label-content">
                                <input class="did-floating-input @error('platform') is-invalid @enderror" type="text"
                                    name="platform" id="platform" value="{{ old('platform') }}">
                                @error('platform')
                                    <p class="small text-danger">{{ $message }}</p>
                                @enderror
                                <label class="did-floating-label"> Platforms Used<span class="m-l-5 text-danger">
                                    (optional)</span>
                                </label>
                            </div>
